...
// List lists all AppGroups in the indexer for a given namespace.
func (s appGroupNamespaceLister) List(selector labels.Selector) (ret []*v1.AppGroup, err error) {
...
// Get retrieves the AppGroup from the indexer for a given namespace and name.
func (s appGroupNamespaceLister) Get(name string) (*v1.AppGroup, error) {
